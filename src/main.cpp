...
public:
    ...
    int main(int argc, char *argv[]) {
        ...
        parser.setApplicationDescription("Shielded desktop light wallet for Arrow");
        ...
        QCoreApplication::setOrganizationName("arrow-org");
        ...
        w = new MainWindow();
        w->setWindowTitle("Quiver Lite v" + QString(APP_VERSION));
